...
Published width changes along a military training route.
...
| `WIDTH_SEQ_NO` | WIDTH Text Computer assigned Sequence Number | Numeric (3,0) (precision, scale) | Not applicable | No | `5` |
| `WIDTH_TEXT` | Route Width Description Text | Text, up to 100 characters | Not applicable | No | `5 NM EITHER SIDE OF CENTERLINE FOR THE ENTIRE ROUTE.` |
...
- `MTR_WDTH.csv` from the 2026-08-06 cycle for example values

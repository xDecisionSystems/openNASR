...
Charts on which a holding pattern is published.
...
| `CHARTING_TYPE_DESC` | Chart on Which Holding Pattern is To Be Depicted. | Text, up to 22 characters | Not applicable | No | `IAP` |
...
- `HPF_CHRT.csv` from the 2026-08-06 cycle for example values

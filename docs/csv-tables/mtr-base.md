...
Military training route identity, type, direction, altitude, and operating information.
...
| `FSS` | All Flight Service Station (FSS) Idents Within 150 Nautical Miles of The Route. | Text, up to 160 characters | nautical miles | Yes | `FAI MCG ORT TKA` |
| `TIME_OF_USE` | Published time-of-use information for the military training route. | Text, up to 175 characters | Not specified by FAA | Yes | `CONTINUOUS` |
...
- `MTR_BASE.csv` from the 2026-08-06 cycle for example values

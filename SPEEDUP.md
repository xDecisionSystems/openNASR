...
- [x] **L6.1 — Agent model: Luna. Done (2026-08-17).** Updated
  [`docs/using-the-library.md`](docs/using-the-library.md) with the public `PlottingIndex`, keyword-only
...
| 2026-08-17 | Complete L6.1/L6.2 while leaving Gate 6 open. | The public `PlottingIndex` lifecycle and batch-plotting guidance are documented in `docs/using-the-library.md`, and the consolidated Phase 2–5 report records the canonical environment, cold/warm policy, and before/after evidence. Release approval still requires the separate S6.3 full release gate. |

...
- [x] **Agent: Terra.** Keep raw records available for fields without typed properties.
...
- [x] **Agent: Terra.** **8.5** Export and document both rich APIs, then update the coverage report
